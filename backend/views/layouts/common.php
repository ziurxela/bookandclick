            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li id="timeline-notifications" class="notifications-menu" <?php if(!Yii::$app->user->can('administrator')){ echo ' style="display: none;"'; } ?>>
                        ...
                        <li id="log-dropdown" class="dropdown notifications-menu" <?php if(!Yii::$app->user->can('administrator')){ echo ' style="display: none;"'; } ?>>
                        ...
                        <li <?php if(Yii::$app->user->can('manager')){ echo ' style="display: none;"'; } ?>>
