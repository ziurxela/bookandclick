...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function getUserProfile()
    {
        ...
        $query = $this->hasOne(UserProfile::className(), ['user_id'=>'id']);
        return $query;
    }
    ...
    public static function getClientName($client = 1)
    {    
        ...
        return ($client !== 1) ? ArrayHelper::getValue($clients, $client) : $clients;
    }
