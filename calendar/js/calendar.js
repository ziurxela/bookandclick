...
(function($) {
	...
	Calendar.prototype.view = function(view) {
		if(view) {
			...
			var date = new Date();
			var hoy = date.getFullYear() + "-" + ("0" + (date.getMonth() + 1)).slice(-2) + "-" + ("0" + date.getDate()).slice(-2);
			if (this.options.day < hoy){
				return;
			}
